...
{
    partial class FormAddPartOfTheCar
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            btnAdd.Location = new Point(467, 160);
            ...
            MinimizeBox = false;
            MinimumSize = new Size(645, 255);
            Name = "FormAddPartOfTheCar";
            ShowIcon = false;
            ShowInTaskbar = false;
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Деталь автомобиля на которой производятся работы";
            ResumeLayout(false);
            PerformLayout();
        }
